...
"[project]/src/app/api/projects/[projectId]/tasks/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        const tasks = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].task.findMany({
            where: {
                projectId,
                ...columnId && {
                    columnId
...
async function POST(req, { params }) {
    try {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$permissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])(userRole, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$permissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PERMISSIONS"].CREATE_TASK)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Forbidden"
            }, {
                status: 403
        ...
        if (parentId) {
            ...
            const parentTask = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].task.findUnique({
                where: {
                    id: parentId
                },
                include: {
            ...
            const tasksToShift = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].task.findMany({
                where: {
                    columnId,
                    order: {
                        gt: insertAfterOrder
            ...
            const lastTask = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].task.findFirst({
                where: {
                    columnId
                },
                orderBy: {
        ...
        const newTask = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].task.create({
            data: {
                title,
                columnId,
                projectId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__319fd13b._.js.map