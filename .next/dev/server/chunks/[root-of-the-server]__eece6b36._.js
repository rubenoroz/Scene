...
"[project]/src/app/api/projects/[projectId]/tasks/[taskId]/duplicate/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    try {
        ...
        async function duplicateTaskRecursive(originalTaskId, newParentId = null) {
            // Get original task with all its data
            const originalTask = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].task.findUnique({
                where: {
                    id: originalTaskId
                },
                include: {
            ...
            const duplicateTask = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].task.create({
                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eece6b36._.js.map